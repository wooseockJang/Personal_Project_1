 ...
 */
package com.simplecoding.repositoryexam.cmmn.web;
...
//	}
	...
	public void initVariables() {
		...
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='"
				+ servletContext.getContextPath()
				+ "/resources/images/egovframework/cmmn/btn_page_pre10.gif' border=0/></a>&#160;";
		
		previousPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='"
				+ servletContext.getContextPath()
				+ "/resources/images/egovframework/cmmn/btn_page_pre1.gif' border=0/></a>&#160;";
		...
		nextPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='"
				+ servletContext.getContextPath()
				+ "/resources/images/egovframework/cmmn/btn_page_next1.gif' border=0/></a>&#160;";
		
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='"
				+ servletContext.getContextPath()
				+ "/resources/images/egovframework/cmmn/btn_page_next10.gif' border=0/></a>&#160;";
	}
