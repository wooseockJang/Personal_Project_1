              ...
              <div class="col-3">
                ...
                <div class="card" style="width: 18rem;">
                   ...
                   <div class="card-body">
                      ...
                      <!-- fn_delete('${data.uuid}')는 JavaScript 함수 호출입니다.
                       JavaScript에서 문자열 인자는 홑따옴표 또는 쌍따옴표로 감싸야 합니다. 따라서 ${data.uuid}의 값을 문자열로 전달하기 위해 홑따옴표를 사용합니다.
                       ${data.fileTitle}와 같은 EL 구문은 HTML 요소에 직접 사용될 때, 그 값이 자동으로 문자열로 처리되기 때문에 홑따옴표나 쌍따옴표 없이 사용할 수 있습니다. --> 
                   </div>
                </div>
              </div>
      		</c:forEach>
